...
int PLA_OOC_Gemm_async( int nb_ooc, int transa, int transb,
		         ...
		         PLA_Obj beta,  PLA_Obj C )
{
  PLA_Obj 
    ...
    A_ooc_2 = NULL, B_ooc_2 = NULL,
    A_in_2 = NULL, B_in_2 = NULL;
...
//      PLA_OOC_Copy_wait(B_ooc_2);
    ...
    PLA_Obj_view_swap(&A_in_1, &A_in_2);
    PLA_Obj_view_swap(&B_in_1, &B_in_2);
    PLA_Obj_view_swap(&A_ooc_1, &A_ooc_2);
    PLA_Obj_view_swap(&B_ooc_1, &B_ooc_2);
  }

  PLA_Obj_free( &A_ooc_L);   PLA_Obj_free( &A_ooc_1 );
  PLA_Obj_free( &A_in_1 );   PLA_Obj_free( &one );
  PLA_Obj_free( &B_ooc_L);   PLA_Obj_free( &B_ooc_1 );
  PLA_Obj_free( &B_in_1 );   PLA_Obj_free( &A_in_2);
  PLA_Obj_free( &B_ooc_2 );   PLA_Obj_free( &A_ooc_2);
  PLA_Obj_free( &B_in_2 );
