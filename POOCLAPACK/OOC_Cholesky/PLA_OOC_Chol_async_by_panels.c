...
/* This Cholesky routine is Async because it calls:
   PLA_OOC_Syrk_async and PLA_OOC_Gemm_async
*/

int PLA_OOC_Chol_async_by_panels( int nb_ooc, int nb_tile, int m_tiles, 
